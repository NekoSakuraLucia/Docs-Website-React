...
const ModalSearch = ({ isOpen, onClose }) => {
  ...
  // สมมติว่านี่คือข้อมูลเอกสารทั้งหมด (ใช้เพื่อทดสอบก่อน)
  const documents = [
    { title: 'แนะนำ', path: '/docs', description: 'เริ่มต้นใช้งานเอกสาร' },
    { title: 'การติดตั้ง', path: '/docs/installation', description: 'วิธีการติดตั้งและตั้งค่า' },
    { title: 'การใช้งานพื้นฐาน', path: '/docs/basic-usage', description: 'เรียนรู้การใช้งานพื้นฐาน' }
  ]
